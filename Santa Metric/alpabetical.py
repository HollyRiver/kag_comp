...
model_loader = HuggingFaceModelLoader(model_path="google/gemma-2-9b", load_in_8bit=False, device_map='auto')
tokenizer = HuggingFaceTokenizer("google/gemma-2-9b")
...
##---------- evaluator ----------
def compute_cost(cfg_list: List[Configuration], batch_size: int = 128) -> float:
